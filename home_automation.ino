...
else if(cmd=="Turn off light two" || cmd=="turn off light 2" || cmd=="Turn off flight 2" || cmd=="turn off flight two" || cmd=="turn off light two" || cmd=="turn off light two" || cmd=="turn off light to")
{
  digitalWrite(7,LOW);
}

else if(cmd=="Turn on all lights" || cmd=="turn on all lights" || cmd=="switch on all lights")
{
  digitalWrite(13,HIGH);
  digitalWrite(7,HIGH);
}
